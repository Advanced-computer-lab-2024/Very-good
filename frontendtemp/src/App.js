  ...
  <div className="form-container">
    ...
    <form onSubmit={handleLogin}>
      ...
      >
        ...
        <Route
          path="/tourist/viewBookedHotels"
          element={<ViewBookedHotelOffers />}
        />
        <Route
          path="/tourist/viewBookedFlights"
          element={<ViewBookedFlightOffers />}
        />
        ...
        <Route
          path="/tourist/viewBookedTransportation"
          element={<ViewBookedTransportationPage />}
        />
        <Route
          path="/tourist/bookTransportation"
          element={<BookTransportationPage />}
        />
        ...
        />
        <Route
          path="/tourismGoverner"
          element={<TourismGovernerPage email={emailoftourism} />}
        />
        <Route
          path="/tourGuide"
          element={<TourGuideHomePage email={emailtourguide} />}
        />
